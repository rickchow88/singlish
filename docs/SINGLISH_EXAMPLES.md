...
Here are 5 example programs written in **SINGLISH** to demonstrate the syntax and "logic" of the language.
...
- Key existence check (`got_lobang`)
- Deleting keys (`buang`)
...
File: [11_pointers.singlish](../examples/11_pointers.singlish)
