...
Save the PRD as JSON in directory: /Users/rickchow/Documents/AI2/singlish/.agents/tasks
...
User request:
review and fix singlish to go transpiler, run codes in /docs/examples, run the code and fix the transiler or update the code
